...
## Terminology
   ...
   (which defines YANG version 1) and {{RFC7950}} (which defines YANG version 1.1), including:
...
{: #fig-cpt title="AMT Protocol Components"}
   ...
   *  Parameters of AMT Relay service, such as Relay Discovery Address
      ...
      the maximum number of tunnels, and secret key rotation interval.
...
# Security Considerations
   ...
   {{RFC4252}}, TLS {{I-D.ietf-tls-rfc8446bis}}, and QUIC {{RFC9000}}) and (2) have to use
